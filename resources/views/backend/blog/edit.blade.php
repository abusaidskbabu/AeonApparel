        ...
        <div class="col-md-9">
            <div  class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><a href="/dashboard/blogs" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a> Edit Blog</h6>
                </div>
                    <div class="card-body">
                        <form method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-sm" name="author" value="{{$data->author}}">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
