        ...
        <div class="col-md-9">
            <div  class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><a href="/dashboard/jobs" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a> Edit Blog</h6>
                </div>
                    <div class="card-body">
                        <form method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <textarea name="content" class="form-control form-control-sm" cols="50" rows="14">{{ $data->content }}</textarea>
                                </div>
                            </div>
                            <hr>
                    </div>
                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <strong>Date:</strong>
                                <input type="date" class="form-control form-control-sm" name="date" value="{{$data->last_date}}">
                            </div>
                        </div>
                        <hr>
                        <div class="row justify-content-center">
                            <button type="submit" class="btn btn-success btn-sm">Update</button> &NonBreakingSpace;&NonBreakingSpace;
                            <a href="/dashboard/blogs" class="btn btn-primary btn-sm">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
