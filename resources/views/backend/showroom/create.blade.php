        ...
        <div class="col-md-11">
            <div  class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><a href="/dashboard/showroom" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a> Create showroom</h6>
                </div>
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-4"><strong>Picture:</strong></div>
                                <div class="col-md-8">
                                    <input type="file" id="file-ip-1" name="workers[]" multiple>
                                    <small class="form-text text-muted">Picture's</small>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
