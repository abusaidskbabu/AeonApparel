        ...
        <div class="col-md-10">
            <div  class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><a href="/dashboard/showroom" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a> Edit Showroom</h6>
                </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        @foreach(explode(",",$data->workers) as $key => $value) 
                                            @if($value != '')
                                                <div class="col-md-2">
                                                    <a href="{{asset('backend/showrooms/'.$value)}}" target="_blank" class="">
                                                        <img src="{{asset('backend/showrooms/'.$value)}}" height="150" width="150" class="mb-1 p-1">
                                                    </a>  
                                                    <a href="{{ route('showroom.worker.delete', ['id'=>$data->id,'image'=>$value])}}" class="delete-image-btn text-danger"><i class="fas fa-times-circle"></i></a>
                                                </div>
                                            @endif
                                        @endforeach
                                    </div>
                                        ...
                                        @foreach(explode(",",$data->gallery) as $key => $value) 
                                            @if($value != '')
                                                <div class="col-md-2">
                                                    ...
                                                    <a href="{{ route('showroom.gallery.delete', ['id'=>$data->id,'image'=>$value])}}" class="delete-image-btn text-danger"><i class="fas fa-times-circle"></i></a>
                                                </div>
                                            @endif
                                        @endforeach
                                    </div>
