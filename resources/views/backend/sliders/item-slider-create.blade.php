        ...
        <div class="row">
            <div class="col-md-9">
                <div  class="card shadow">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('item-slider-store') }}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            @if (count($errors) > 0)
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small class="form-text text-muted">Image Dimension Should Be 1920*1280 or 2:1 for perfect view</small>
                                    <div class="preview">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <a href="{{route('item.sliders.index')}}" class="btn btn-primary btn-sm">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
