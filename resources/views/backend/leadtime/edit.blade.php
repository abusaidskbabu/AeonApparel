        ...
        <div class="col-md-10">
            <div  class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><a href="/dashboard/leadtime" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a> Edit Lead Time</h6>
                </div>
                    <div class="card-body">
                        <form method="POST"  enctype="multipart/form-data">
                           ...
                           <div class="row">
                                ...
                                <div class="col-md-8">
                                    <textarea name="details" class="form-control form-control-sm" id="desc" cols="50" rows="16">{!! $data->details !!}</textarea>
                                </div>
                            </div>
                            <hr>
