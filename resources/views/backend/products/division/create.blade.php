        ...
        <div class="col-md-9">
            <div  class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><a href="{{route('division.index')}}" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a> Create Product Division</h6>
                </div>
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-sm" name="division_name" value="{{old('division_name')}}" placeholder="Ex. Woven">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
