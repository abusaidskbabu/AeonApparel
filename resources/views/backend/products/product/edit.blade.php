                                ...
                                <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control form-control-sm" name="division">
                                                ...
                                                @foreach ($division as $div)
                                                    <option {{ $div->id == $data->division ? 'selected' : '' }} value="{{$div->id}}">{{$div->division_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control form-control-sm" name="gender">
                                                ...
                                                @foreach ($gender as $gen)
                                                    <option {{ $gen->id == $data->gender ? 'selected' : '' }} value="{{$gen->id}}">{{$gen->gender_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="preview">
                                                <img src="{{ asset($data->image_front) }}" id="file-ip-1-preview" height="100" width="100" border="0">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <strong>Back:</strong>
                                            ...
                                            <div class="preview">
                                                <img src="{{ asset($data->image_back) }}" id="file-ip-2-preview" height="100" width="100" border="0">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control form-control-sm"
                                                   name="color" value="{{ $data->color }}" placeholder="Ex: Black, White">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control form-control-sm"
                                                   name="size" value="{{ $data->size }}" placeholder="Ex: XL, L, 34">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <textarea name="desc" class="form-control form-control-sm" id="desc" cols="50" rows="16">{{ $data->description }}</textarea>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
