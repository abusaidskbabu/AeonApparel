        ...
        <div class="col-md-10">
            <div  class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><a href="/dashboard/servicesinformation" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a> Edit Service</h6>
                </div>
                    <div class="card-body">
                        <form method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control form-control-sm" name="icon_2" placeholder="fa fa-cogs" value="{{$data->icon_2}}">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="preview">
                                        <img id="file-ip-1-preview" src="{{asset($data->icon)}}" height="60" width="60">
                                        <input type="hidden" name="prev_img" value="{{$data->icon}}">
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <textarea name="overview" class="form-control form-control-sm" id="overview" cols="50" rows="16">{{ $data->overview }}</textarea>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
